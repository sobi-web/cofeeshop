                    ...
                    <div class="product-box-slider-2 no-arrow">
                            ...
                            <div class="product-box product-box-bg wow fadeInUp">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">
                                            نان سبوس دار کلوچه و تاف 400 گرم
                                        </h6>
                                    </a>

                                    <h5 class="sold text-content">
                                        <span class="theme-color price">26.690 تومان</span>
                                        <del>28.560</del>
                                    </h5>
                                    ...
                                    <div class="product-rating mt-2">
                                        ...
                                        <h6 class="theme-color">موجود در انبار</h6>
                                    </div>
                        ...
                        <div>
                            <div class="product-box product-box-bg wow fadeInUp">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">
                                            بیسکویت کره بادام زمینی پرمیوم کره 600 گرم
                                        </h6>
                                    </a>
                            ...
                            <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="product-detail">
                                    <h6 class="name">
                                        چیپس نمکی تهیه شده از بهترین سیب زمینی ها
                                    </h6>
                                    </a>
                        ...
                        <div>
                            <div class="product-box product-box-bg wow fadeInUp">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">
                                            چیپس سیب زمینی پاشیده چیلی یومیتوس 100 گرم
                                        </h6>
                                    </a>
                            ...
                            <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">
                                            بیسکوییت های ترد فانتزی شکلات چیپ
                                        </h6>
                                    </a>
                        ...
                        <div>
                            <div class="product-box product-box-bg wow fadeInUp">
                                <div class="product-image">
                                    <a href="product.html">
                                        <img src="{{ asset('front/images/cake/product/7.png') }}"
                                             class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="نمایش">
                            ...
                            <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product.html">
                                        <img src="{{ asset('front/images/cake/product/8.png') }}"
                                             class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="نمایش">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">
                                            قالب شکلات قلب سیلیکونی شیری ( بسته 1 عددی )
                                        </h6>
                                    </a>
                        ...
                        <div>
                            <div class="product-box product-box-bg wow fadeInUp">
                                <div class="product-image">
                                    <a href="product.html">
                                        <img src="{{ asset('front/images/cake/product/9.png') }}"
                                             class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="نمایش">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">بیسکویت شکلاتی 250 گرم</h6>
                                    </a>
                            ...
                            <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-image">
                                    <a href="product.html">
                                        <img src="{{ asset('front/images/cake/product/10.png') }}"
                                             class="img-fluid blur-up lazyload" alt="">
                                    </a>
                                    <ul class="product-option">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="نمایش">
                                ...
                                <div class="product-detail">
                                    <a href="product-left.html">
                                        <h6 class="name">
                                            جا کیک مخصوص تولد و جشن عروسی 100 گرم
                                        </h6>
                                    </a>
                        ...
                        <div>
                            <div class="product-box product-box-bg wow fadeIn">
                                ...
                                <div class="product-detail">
                                    ...
                                    <h6 class="sold weight text-content fw-normal">1 کیلوگرم</h6>
